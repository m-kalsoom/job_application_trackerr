...
import { Button } from "@/components/ui/button";"./create-job-dialog";
...
function DroppableColumn({
  ...
  return (
    <Card className="w-80 min-w-80 flex-shrink-0 rounded-2xl shadow-sm p-0">
      <CardHeader
      ...
      <CardContent ref={setNodeRef} className={` space-y-3 pt-4 bg-gray-50/50 rounded-b-2xl h-[70vh] 
      overflow-y-auto ${ isOver ? "ring-2 ring-blue-500": "" }`} >
        <SortableContext
